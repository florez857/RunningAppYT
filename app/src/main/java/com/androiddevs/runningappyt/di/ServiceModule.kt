...
object ServiceModule {
    ...
    @ServiceScoped
    @Provides
    fun provideFusedLocationProvidrClient(@ApplicationContext app: Context) =
        FusedLocationProviderClient(app)


    @ServiceScoped
    @Provides
    fun provideMainPendingIntent(@ApplicationContext app: Context) = PendingIntent.getActivity(
        app,
        0,
